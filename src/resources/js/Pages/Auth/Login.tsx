	...
	return (
		<div className="min-h-screen flex items-center justify-center bg-gray-50">
			<div className="w-full max-w-lg bg-white p-8 rounded-lg shadow-md">
				<h1 className="text-2xl font-bold mb-6 text-center text-red-500">ログインページ</h1>
				<form onSubmit={handleSubmit(onSubmit)} noValidate>
					...
					<button type="submit" className="w-full bg-blue-500 text-white font-semibold py-2 rounded-md transition-colors mt-2 hover:bg-blue-700">
						ログイン
					</button>
				</form>
