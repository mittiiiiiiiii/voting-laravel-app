		...
		<div className="flex min-h-screen items-center justify-center bg-gray-50">
			<div className="w-full max-w-xl bg-white p-8 rounded-lg shadow-md">
				...
				<form onSubmit={handleSubmit(onSubmit)} noValidate>
					...
					<button type="submit" className="w-full bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded-md mt-2 transition">ログイン</button>
				</form>
				<p className="mt-4 text-center text-sm">
					アカウントをお持ちでない方は
					<a href="/auth/register" className="text-blue-700 underline ml-1 hover:text-blue-900">こちら</a>
				</p>
			</div>
		</div>
	);
